...
/* Exported constants --------------------------------------------------------*/
/* Exported macros -----------------------------------------------------------*/
//Pines originales de la PCB, cambio de I2C a Serial.
// #define GD1 (GPIO_PIN_6)
// #define BD1 (GPIO_PIN_5)
#define GD1 (GPIO_PIN_5)//Antiguo SDA
#define BD1 (GPIO_PIN_4)//Antiguo SCL

#define GD2 (GPIO_PIN_3)
#define BD2 (GPIO_PIN_4)
#define GD3 (GPIO_PIN_5)
#define BD3 (GPIO_PIN_6)
#define GD4 (GPIO_PIN_7)
#define BD4 (GPIO_PIN_1)
#define GD5 (GPIO_PIN_2)
#define BD5 (GPIO_PIN_3)

#define BUZZER  (GPIO_PIN_3)
#define BOTON (GPIO_PIN_4)

#define PINESO_PORTC (GD2|BD2|GD3|BD3|GD4)
//#define PINESO_PORTD (GD5|BD5|BD1|GD1|BD4)
#define PINESO_PORTD (GD5|BD5|BD4)

#define PINESO_PORTB (BD1|GD1) //Nuevos pines para led1
//Antiguos pines I2C
// #define SDA  (GPIO_PIN_5)
// #define SCLK (GPIO_PIN_4)
#define RX_STM8 (GPIO_PIN_5)
#define TX_STM8 (GPIO_PIN_6)
/* Private macros ------------------------------------------------------------*/
