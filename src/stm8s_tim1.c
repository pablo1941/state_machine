...
{
  //Tiempo configurado para interrupción por 1 segundo.
    TIM1_DeInit();
    //Prescaler,Modo del contador, valor contador, Repetidor.
    //TIM1_TimeBaseInit(128, TIM1_COUNTERMODE_DOWN, 125, 0); //ton = 16*500*1/16MHz => 0.5KHz del Buzzer
    TIM1_TimeBaseInit(16, TIM1_COUNTERMODE_DOWN, 500, 0); //ton = 16*500*1/16MHz => 1KHz del Buzzer
    //TIM1_TimeBaseInit(16, TIM1_COUNTERMODE_DOWN, 250, 1); //ton = 16*250*1/16MHz => 2KHz del Buzzer
    TIM1_ITConfig(TIM1_IT_UPDATE, ENABLE);
    //TIM1_Cmd(ENABLE);
   // enableInterrupts();
} 

void TIM1_setup2(void)
{
  //Tiempo configurado para interrupción por 1 segundo.
    TIM1_DeInit();
    //Prescaler,Modo del contador, valor contador, Repetidor.
    //TIM1_TimeBaseInit(128, TIM1_COUNTERMODE_DOWN, 125, 0); //ton = 16*500*1/16MHz => 0.5KHz del Buzzer
    //TIM1_TimeBaseInit(16, TIM1_COUNTERMODE_DOWN, 500, 0); //ton = 16*500*1/16MHz => 1KHz del Buzzer
    TIM1_TimeBaseInit(16, TIM1_COUNTERMODE_DOWN, 250, 0); //ton = 16*250*1/16MHz => 2KHz del Buzzer
    TIM1_ITConfig(TIM1_IT_UPDATE, ENABLE);
    //TIM1_Cmd(ENABLE);
   // enableInterrupts();
} 
